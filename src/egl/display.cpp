...
//============================================================================
EGLConfig display::create_config(EGLint const* attr_list) {
  EGLint    num_cfgs;
  EGLConfig config;
...
//------------------------------------------------------------------------------
EGLint display::num_configs() const {
  EGLint num_configs{};
...
//------------------------------------------------------------------------------
 std::vector<EGLConfig> display::all_configs() const {
...
//------------------------------------------------------------------------------
std::pair<XVisualInfo*, EGLConfig> display::create_visual_info(
  ...
  visual_info = XGetVisualInfo(x11_disp->get(), VisualIDMask, &visual_template,
