...
struct IndexBufferFixture2140 {
  Context     c;
  IndexBuffer ibo;
  IndexBufferFixture2140() : c{4, 5}, ibo{2, 1, 4, 0} {}
  static constexpr std::array<unsigned int, 4> correct_ibo_data{2, 1, 4, 0};
};

struct IndexBufferFixture {
  Context     c;
  IndexBuffer ibo;
  IndexBufferFixture() : c{4, 5} {}
};

//==============================================================================
TEST_CASE_METHOD(IndexBufferFixture, "[IBO] default construction", "[indexbuffer][buffer]") {
