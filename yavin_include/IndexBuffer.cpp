...
IndexBuffer::IndexBuffer(const std::vector<unsigned int>& data, bool direct_upload,
...
IndexBuffer::IndexBuffer(std::initializer_list<unsigned int>&& list, bool direct_upload,
                         bool keep_data_on_cpu)
