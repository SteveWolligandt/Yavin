...
class Texture2D : public BaseTexture<GL_TEXTURE_2D, type, components> {
 ...
 public:
  ...
  //----------------------------------------------------------------------------
  Texture2D(size_t width, size_t height, tex::InterpolationMode interp_mode,
            tex::WrapMode wrap_mode)
      : Texture2D(width, height, interp_mode, interp_mode, wrap_mode,
                  wrap_mode) {}

  //----------------------------------------------------------------------------
  Texture2D(size_t width, size_t height, tex::InterpolationMode interp_mode_min,
            tex::InterpolationMode interp_mode_mag, tex::WrapMode wrap_mode_s,
            tex::WrapMode wrap_mode_t);

  //----------------------------------------------------------------------------
  template <typename S>
  Texture2D(size_t width, size_t height, const std::vector<S>& data)
 ...
 public:
  //----------------------------------------------------------------------------
  template <typename S>
  void upload_data(size_t width, size_t height, const std::vector<S>& data);
...
//------------------------------------------------------------------------------
template <typename type, typename components>
Texture2D<type, components>::Texture2D(size_t width, size_t height,
                                       tex::InterpolationMode interp_mode_min,
                                       tex::InterpolationMode interp_mode_mag,
                                       tex::WrapMode          wrap_mode_s,
                                       tex::WrapMode          wrap_mode_t)
...
template <typename type, typename components>
template <typename S>
void Texture2D<type, components>::upload_data(size_t width, size_t height,
                                              const std::vector<S>& data) {
  m_width  = width;
  m_height = height;
...
//------------------------------------------------------------------------------
template <typename type, typename components>
void Texture2D<type, components>::resize(size_t width, size_t height) {
