...
class behaviour_t {
 public:
  ...
  behaviour_t(const behaviour_t<T>& other) : m_scene_object(other.m_scene_object) {}
  ...
  virtual void on_render(const Yavin::Camera& /*cam*/) {}

  virtual std::optional<collision_t<T>> check_collision(const Yavin::ray_t<T>& /*r*/) { return {}; }
